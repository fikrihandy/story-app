...
import academy.bangkit.storyApp.data.StoryPagingSource
...
class UserRepository private constructor(
    ...
    fun getAllStoriesWithLocation(
        ...
        val client: Call<GetAllStoriesResponse> = ApiConfig.getApiService(token).getAllStories(1)
    ...
    fun uploadImage(
        ...
        val filePart = MultipartBody.Part.createFormData("photo", imageFile.name, requestImageFile)
        ...
        try {
            val successResponse = ApiConfig.getApiService(token)
                .uploadImage(filePart, descriptionPart, latPart, lonPart)
